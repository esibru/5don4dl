...
Nous allons à présent apprendre à ajouter des noeuds (sommets) et des relations (arcs) à notre graphe au moyen du langage Cypher. Pour ce faire simplement, utilisez la zone de texte située au dessus de l'interface web:
