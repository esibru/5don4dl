...
Reprenons notre graphe modélisant le réseau autoroutier de la Belgique. Pour créer un noeud dont le nom est Bruxelles et l'id est 1, utilisez la requête **CREATE** de la sorte:
...
La requête à utiliser est donc la suivante (c1 et c2 sont les noms des variables mentionnées ci-dessus):
