...
Reprenons notre graphe modélisant le réseau autoroutier européen. Pour créer un noeud dont le nom est Bruxelles, le pays la Belgique et l'id est 1, utilisez la requête **CREATE** de la sorte:
