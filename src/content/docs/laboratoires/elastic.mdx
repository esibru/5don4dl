...
Voyez ensemble comment configurer le stemming. Pour cela, nous allons devoir créer un nouvel index et lui fournir la configuration JSON suivante:
...
2. Creéez l'index au moyen du code:
...
4. Testez au moyen d'une recher sur base du mot `Analyse` que tous ces cours sont bien renvoyés.
