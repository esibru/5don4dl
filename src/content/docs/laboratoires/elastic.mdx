...
Voyez la documentation officielle pour une explication détaillée de la librairie: https://www.elastic.co/docs/reference/elasticsearch/clients/java/setup/connecting
